...
10.times do |i|
   Event.create(start_date:Faker::Date.between(from: Date.today, to:100.days.after),duration:[5,10,15,20,25,30,35,40,45].sample,title:Faker::Creature::Animal.name,description:Faker::ChuckNorris.fact,price:rand(1..900),location:Faker::Address.street_name,admin_id:User.all.sample.id)
